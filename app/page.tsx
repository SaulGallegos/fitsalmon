          ...
          <div className="space-y-24 max-w-6xl mx-auto">
            ...
            <Link href="/demo" target="_blank" rel="noopener noreferrer" className="relative group block cursor-pointer">
              ...
              <div className="relative overflow-hidden rounded-[2rem] border-[3px] border-[#e9e5dc]/50 bg-gradient-to-b from-[#0a1a14] to-[#050f0a] shadow-[0_40px_100px_rgba(0,0,0,0.8),0_20px_60px_rgba(237,101,49,0.15),inset_0_1px_0_rgba(255,255,255,0.15),inset_0_-1px_0_rgba(237,101,49,0.1)] group-hover:shadow-[0_50px_120px_rgba(0,0,0,0.9),0_30px_80px_rgba(237,101,49,0.3),inset_0_2px_0_rgba(255,255,255,0.2),inset_0_-2px_0_rgba(237,101,49,0.2)] group-hover:scale-[1.015] group-hover:border-[#ed6531]/70 transition-all duration-700 backdrop-blur-xl ring-1 ring-white/5">
                <div className="aspect-video relative bg-gradient-to-br from-[#0a1a14] to-[#050f0a] p-6">
                  <img
                    ...
                    className="w-full h-full object-contain drop-shadow-[0_10px_40px_rgba(0,0,0,0.8)]"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700"></div>
                </div>
                <div className="absolute bottom-0 left-0 right-0 p-10 bg-gradient-to-t from-black/95 via-black/80 to-transparent backdrop-blur-xl border-t border-white/5 translate-y-3 group-hover:translate-y-0 transition-transform duration-700">
                  <div className="flex items-center gap-4 mb-4">
                    <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-[#ed6531] via-[#ff7e4d] to-[#ed6531] flex items-center justify-center shadow-[0_12px_40px_rgba(237,101,49,0.6),0_0_20px_rgba(237,101,49,0.4),inset_0_1px_0_rgba(255,255,255,0.3)] ring-2 ring-[#ed6531]/30">
                      <svg className="w-7 h-7 text-white drop-shadow-[0_2px_8px_rgba(0,0,0,0.5)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                      </svg>
                    </div>
                    <h3 className="text-3xl font-extrabold text-white drop-shadow-[0_4px_12px_rgba(0,0,0,0.9)] tracking-tight">Perfiles de Clientes Completos</h3>
                  </div>
            ...
            <Link href="/demo" target="_blank" rel="noopener noreferrer" className="relative group block cursor-pointer">
              ...
              <div className="relative overflow-hidden rounded-[2rem] border-[3px] border-[#e9e5dc]/50 bg-gradient-to-b from-[#0a1a14] to-[#050f0a] shadow-[0_40px_100px_rgba(0,0,0,0.8),0_20px_60px_rgba(212,255,0,0.1),inset_0_1px_0_rgba(255,255,255,0.15),inset_0_-1px_0_rgba(212,255,0,0.1)] group-hover:shadow-[0_50px_120px_rgba(0,0,0,0.9),0_30px_80px_rgba(212,255,0,0.2),inset_0_2px_0_rgba(255,255,255,0.2),inset_0_-2px_0_rgba(212,255,0,0.2)] group-hover:scale-[1.015] group-hover:border-[#d4ff00]/70 transition-all duration-700 backdrop-blur-xl ring-1 ring-white/5">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-10 bg-gradient-to-t from-black/95 via-black/80 to-transparent backdrop-blur-xl border-t border-white/5 translate-y-3 group-hover:translate-y-0 transition-transform duration-700">
                  <div className="flex items-center gap-4 mb-4">
                    <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-[#d4ff00] via-[#b8db00] to-[#d4ff00] flex items-center justify-center shadow-[0_12px_40px_rgba(212,255,0,0.6),0_0_20px_rgba(212,255,0,0.4),inset_0_1px_0_rgba(255,255,255,0.3)] ring-2 ring-[#d4ff00]/30">
                      <svg className="w-7 h-7 text-[#0f231c] drop-shadow-[0_2px_8px_rgba(0,0,0,0.5)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z" />
                      </svg>
                    </div>
                    <h3 className="text-3xl font-extrabold text-white drop-shadow-[0_4px_12px_rgba(0,0,0,0.9)] tracking-tight">Bandeja de Entrada Unificada</h3>
                  </div>
            ...
            <Link href="/demo" target="_blank" rel="noopener noreferrer" className="relative group block cursor-pointer">
              ...
              <div className="relative overflow-hidden rounded-[2rem] border-[3px] border-[#e9e5dc]/50 bg-gradient-to-b from-[#0a1a14] to-[#050f0a] shadow-[0_40px_100px_rgba(0,0,0,0.8),0_20px_60px_rgba(76,175,80,0.15),inset_0_1px_0_rgba(255,255,255,0.15),inset_0_-1px_0_rgba(76,175,80,0.1)] group-hover:shadow-[0_50px_120px_rgba(0,0,0,0.9),0_30px_80px_rgba(76,175,80,0.3),inset_0_2px_0_rgba(255,255,255,0.2),inset_0_-2px_0_rgba(76,175,80,0.2)] group-hover:scale-[1.015] group-hover:border-[#4caf50]/70 transition-all duration-700 backdrop-blur-xl ring-1 ring-white/5">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-10 bg-gradient-to-t from-black/95 via-black/80 to-transparent backdrop-blur-xl border-t border-white/5 translate-y-3 group-hover:translate-y-0 transition-transform duration-700">
                  <div className="flex items-center gap-4 mb-4">
                    <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-[#4caf50] via-[#45a049] to-[#4caf50] flex items-center justify-center shadow-[0_12px_40px_rgba(76,175,80,0.6),0_0_20px_rgba(76,175,80,0.4),inset_0_1px_0_rgba(255,255,255,0.3)] ring-2 ring-[#4caf50]/30">
                      <svg className="w-7 h-7 text-white drop-shadow-[0_2px_8px_rgba(0,0,0,0.5)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                      </svg>
                    </div>
                    <h3 className="text-3xl font-extrabold text-white drop-shadow-[0_4px_12px_rgba(0,0,0,0.9)] tracking-tight">Calendario Inteligente</h3>
                  </div>
